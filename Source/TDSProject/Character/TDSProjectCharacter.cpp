...
void ATDSProjectCharacter::SetupPlayerInputComponent(UInputComponent* NewInputComponent)
{
    Super::SetupPlayerInputComponent(NewInputComponent);

    NewInputComponent->BindAxis(TEXT("MoveForward"), this, &ATDSProjectCharacter::InputAxisX);
    NewInputComponent->BindAxis(TEXT("MoveRight"), this, &ATDSProjectCharacter::InputAxisY);
}
...
void ATDSProjectCharacter::ChangeMovementState(EMovementState NewMovementState) 
{
